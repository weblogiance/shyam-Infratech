...
const Home = () => {
  ...
  <div className="w-full">
    <div className="relative">
      ...
      <img
        src={front}
        alt="Foreground"
        className="absolute top-0 left-0 w-full lg:min-h-screen h-[70vh] object-cover"
      />
      {/* Content Section */}
  ...
  <div className="lg:w-1/2 w-full text-center lg:text-left">
    ...
    <p className="mt-4 text-gray-500 max-w-2xl text-sm text-justify leading-relaxed">
