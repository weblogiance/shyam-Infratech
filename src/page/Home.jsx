    ...
    <div>
      ...
      <section className="relative w-full  flex items-center justify-center">
          <div className={`w-full `}>
              <div>
              <img src={bg} alt="" className='w-full h-screen object-cover' />
            <img src={front} alt="" className='absolute top-0 left-0 w-full h-screen object-cover' />
            <div className='absolute w-11/12 top-0 left-[50%] -translate-x-[50%] mx-auto gap-y-10 h-screen flex items-start justify-center flex-col'>
                  <h1 className=' text-8xl max-w-5xl font-semibold text-white leading-snug '>Reliable Infrastructure Solution for a Better Tomorrow</h1>
      ...
      <section className="w-10/12  gap-x-30 mx-auto flex items-center justify-between mb-10">
        {/* Text Content */}
        <div className=' w-1/2'>
          <h2 className="text-5xl leading-14 max-w-lg font-bold text-gray-900">
            Providing all kinds of Construction Services
          </h2>
          <p className="mt-4 text-2xl max-w-2xl leading-8 text-gray-600 font-medium">
            Our construction company has been founded 10 years ago, at the very peak of the building frenzy in the US...
          </p>
          <p className="mt-4 text-lg text-gray-500 max-w-3xl text-justify leading-relaxed">
        ...
        <div className="relative ">
          <img
            ...
            className="w-[824px]  h-[755px] rounded-4xl shadow-lg"
          />
        </div>
      </section>
      <Ourservice />
